...
function Header(props) {
  ...
  const toggleSelectAllActualRows = () => {
    ...
    setSelectedRows((prev) =>
      prev.map((data) =>
        idActualRows.includes(data.id)
          ? { ...data, isSelected: !isAllActualRowsSelected }
          : data
      )
    );
      ...
      <tr>
        <th>
          <i
            className={
              "fa-square" +
              (isAllActualRowsSelected || isAllRowsSelected ? "-check" : "") +
              " fa-" +
                ...
                {["asc", "desc"].map((direction) => (
                  <i
                    ...
                    className={
                      ...
                      (sort.key === value && sort.direction === direction
                        ? " active"
                        : value === hoveredHeader
                        ? ""
                        : " hide")
          ...
          <i
            className={
              ...
              (isAllActualRowsSelected || isAllRowsSelected ? "" : "hide")
            }
