...
import logo from "assets/image/logo/logo-dark.webp";
import shortLogo from "assets/image/logo/short-logo-dark.webp";
...
function Nav() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Ocultar cuando baja
      currentScrollY > prevScrollY && currentScrollY > 100
        ? setIsVisible(false)
        : // Mostrar cuando sube
    ...
    >
      <ul className="links">
        {isMobile && (
          <li>
            {" "}
            <i
              className={`fa-solid fa-${isShowMenu ? "xmark" : "bars"}`}
          ...
          <>
            <li>
              <a
                href="#Hero"
                className={`${
                  isMobile && actualSection === "Hero" ? "selected" : ""
                }`}
                onClick={() => selectMenu("Hero")}
              >
                {isMobile ? (
                  "Home"
                ) : (
                  <img src={isTablet ? shortLogo : logo} alt="Logo BICKET" />
                )}
              </a>
            </li>
            <li>
              <a
                href="#Features"
                className={`${
                  isMobile && actualSection === "Features" ? "selected" : ""
                }`}
                onClick={() => selectMenu("Features")}
              >
                Features
              </a>
            </li>
            <li>
              <a
                href="#Pricing"
                className={`${
                  isMobile && actualSection === "Pricing" ? "selected" : ""
                }`}
                onClick={() => selectMenu("Pricing")}
              >
                Pricing
              </a>
            </li>
            <li>
              <a
                href="#QA"
                className={`${
                  isMobile && actualSection === "QA" ? "selected" : ""
                }`}
                onClick={() => selectMenu("QA")}
              >
                QA
              </a>
            </li>
      ...
      {((isMobile && !isShowMenu) || !isMobile) && (
        ...
        >
          ...
          <li className="signIn">
            <button onClick={() => navigate("/authentication/sign-in")}>
              Sign In
            </button>
          </li>
        </ul>
