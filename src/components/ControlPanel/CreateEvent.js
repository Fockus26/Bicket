...
function CreateEvent() {
  ...
  const sendEventData = e => {
    e.preventDefault();
    isAllVerified ? navigate('/control-panel/dashboard')
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                <input placeholder='section' type="text" id="TicketName" name="TicketName" />
                {/* Cantidad de tickets */}
                <input placeholder='quantity' type="number" id="TicketAmount" name="TicketAmount" />
                {/* Tipo de tickets */}
